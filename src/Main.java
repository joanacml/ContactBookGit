...
public class Main {
    ...
    public static final String GET_NAME = "GN"; //new

    public static final String EQUAL_PHONES = "EP"; //new
    ...
    private static final String PHONE_NOT_EXIST = "Phone number does not exist."; //new
    private static final String EQUAL_PHONE = "There are contacts that share phone numbers."; //new
    private static final String DIFF_PHONE = "All contacts have different phone numbers."; //new
